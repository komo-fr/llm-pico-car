...
i18n = gr.I18n(
    ...
    en={
        ...
        # Tabs
        "tab_text": "Text Instructions",
        "tab_audio": "Audio Instructions",
        "tab_image": "Image Instructions",
        ...
        "text_input_placeholder": "Move forward a bit, then stop",
        # Audio tab
        ...
        "settings_step3": "Step 3 | Enter the values measured in Step 2 into 'Measured: Distance per second' and 'Measured: Rotation angle per second' and configure\n⚠️ If you change 'Drive speed' / 'Turn speed', repeat from Step 2 after configuration",
        ...
        "transcription_failed": "Transcription failed. Terminating",
